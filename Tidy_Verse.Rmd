...
```{r fig-margin, fig.margin = TRUE, fig.cap = "RELACION DIST vs SPEED", fig.width=3.5, fig.height=3.5, cache=TRUE}
...
```{r fig-margin2, fig.margin = TRUE, fig.cap = "RELACION DIST vs SPEED", fig.width=3.5, fig.height=3.5, cache=TRUE}
library(dplyr)
library(ggplot2)
cars_nuevo <- cars[cars$speed > 15, ] %>%
  as.data.frame() %>%
